...
import dev.application.common.dto.AverageFeatureOutputDTO;
...
public class AverageFeatureSubLogic {
	...
	public void execute(List<ThresHoldEntity> entityList, String file)
		...
		AverageFeatureEntity averageFeatureEntity = new AverageFeatureEntity();
		...
		averageFeatureEntity = new AverageFeatureEntity();
	 ...
	 */
	public static void executeAverageFeatureMain(List<AverageFeatureEntity> insertEntities) {
