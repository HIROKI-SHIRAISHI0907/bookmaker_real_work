...
import dev.application.common.constant.ClassifyScoreAIConst;
...
public class ClassifyScoreAISubLogic {
	...
	public void execute(List<ThresHoldEntity> entityList, String file)
		...
		List<ClassifyResultDataEntity> insertEntities = new ArrayList<ClassifyResultDataEntity>();
		// 最大の通番を持つ時間を返却する
		...
		for (ClassifyResultDataEntity entity : insertEntities) {
	 ...
	 * @param file_name
	 */
	public static void executeClassifyScoreMain(List<ClassifyResultDataEntity> insertEntities,
	 ...
	 */
	private ClassifyResultDataEntity mappingEntity(String classify_mode, ThresHoldEntity thresholdEntity) {
		ClassifyResultDataEntity mappingDto = new ClassifyResultDataEntity();
