...
public class ScoringPlaystylePastDiffDataSubLogic {
	...
	public void execute(List<ThresHoldEntity> entityList, String file)
		...
		List<DiffFeatureEntity> diffFeatureEntities = new ArrayList<DiffFeatureEntity>();
		for (int entityInd = 0; entityInd < entityList.size() - 1; entityInd++) {
			// DiffEntityインスタンスを生成
			DiffFeatureEntity diffEntity = new DiffFeatureEntity();
	 ...
	 */
	public static void executeDiffDataMain(List<DiffFeatureEntity> insertEntities) {
