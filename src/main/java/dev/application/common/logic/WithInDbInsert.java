...
public class WithInDbInsert {
	...
	public void execute(String seq, Integer target, String flg)
		...
		List<BookDataInsertEntity> conditionList = new ArrayList<BookDataInsertEntity>();
		...
		try {
			...
			if (!selectResultList.isEmpty()) {
				...
				for (List<String> list : selectResultList) {
					BookDataInsertEntity mapSelectDestination = mappingSelectEntity(list);
		...
		List<BookDataInsertEntity> ChkConditionList = new ArrayList<BookDataInsertEntity>();
		try {
	 ...
	 * @throws Exception
	 */
	private BookDataInsertEntity mappingSelectEntity(List<String> parts) throws Exception {
		BookDataInsertEntity mappingDto = new BookDataInsertEntity();
