...
public class WithInXMinutesDbInsert {
	 ...
	 */
	public void execute(List<BookDataInsertEntity> conditionList, Integer search,
			String flg)
	...
	private List<?> tableListContainsChkReturnEntity(String tableId,
			...
			String feature, String thresHold) {
		if (WITHIN_CONTAINS_MAP.contains(tableId)) {
			List<WithinDataXMinutesEntity> insertList = new ArrayList<WithinDataXMinutesEntity>();
			WithinDataXMinutesEntity withinDataXMinutesEntity = new WithinDataXMinutesEntity();
			...
			List<WithinDataXMinutesAllLeagueEntity> insertList = new ArrayList<WithinDataXMinutesAllLeagueEntity>();
			WithinDataXMinutesAllLeagueEntity withinDataXMinutesAllLeagueEntity = new WithinDataXMinutesAllLeagueEntity();
