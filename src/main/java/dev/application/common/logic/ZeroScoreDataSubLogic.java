...
public class ZeroScoreDataSubLogic {
	 ...
	 */
	public static void executeNoScoredMain(List<NoScoredEntity> insertEntities) {
	 ...
	 */
	private NoScoredEntity mappingEntity(ThresHoldEntity thresholdEntity) {
		NoScoredEntity mappingDto = new NoScoredEntity();
