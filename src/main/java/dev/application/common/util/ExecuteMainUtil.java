...
public class ExecuteMainUtil {
	 ...
	 * @return
	 */
	public static ThresHoldEntity getMaxSeqEntities(List<ThresHoldEntity> entityList) {
		int seq = -1;
		ThresHoldEntity returnEntity = null;
		for (ThresHoldEntity entity : entityList) {
			...
			if (BookMakersCommonConst.FIN.equals(entity.getTimes())) {
				return entity;
			}
		}
		return returnEntity;
	 ...
	 * @return
	 */
	public static ThresHoldEntity getHalfEntities(List<ThresHoldEntity> entityList) {
		ThresHoldEntity returnEntity = null;
		for (ThresHoldEntity entity : entityList) {
	 ...
	 * @return
	 */
	public static ThresHoldEntity getMinSeqEntities(List<ThresHoldEntity> entityList) {
