...
import dev.application.common.logic.AnalyzeThresholdGettingScoreLogic;

@Tag("IT")
//@SpringBootTest(classes = BookMakersConfig.class)
//@MapperScan("dev.application.repository")
//@ActiveProfiles("test")
class AnalyzeThresholdGettingScoreLogicTest {
    ...
    void testExecute_NormalCase_Register() throws Exception {
        // モックの設定: 正常ケース
    	AnalyzeThresholdGettingScoreLogic logicBatch = new AnalyzeThresholdGettingScoreLogic();
